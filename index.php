...
>> PING <code>@EcoXP</code> For Purchasing
Note -⟩ We Only Accept  Webmoney And Crytpo</b>");

$nopre = urlencode("<b>YOU NEED TO BE PREMIUM TO USE THIS COMMAND.
Hit /buy to purchase</b>");
$botToken =  "5519693729:AAHjxAQWv6hbfXqsjeTFc3CvpHA4LjmHsag";
...
$free = json_encode($keyboard);
        file_get_contents("https://api.telegram.org/bot5519693729:AAHjxAQWv6hbfXqsjeTFc3CvpHA4LjmHsag/editMessageText?chat_id=$cchatid2&text=$freecommands&message_id=$cmessage_id2&parse_mode=HTML&reply_markup=$free");
...
if ($cdata2 == "buy"){
    ...
    $keyboard = [
    'inline_keyboard' => [
         [['text' => 'Buy Now', 'url' => 'https://t.me/ecoxp'], 
         ['text' => 'Premium', 'callback_data' => 'paid'],
         ['text' => 'Finalize', 'callback_data' => 'end']]
        ]];
...
file_get_contents("https://api.telegram.org/5519693729:AAHjxAQWv6hbfXqsjeTFc3CvpHA4LjmHsag/editMessageText?chat_id=$cchatid2&text=$finalize&message_id=$cmessage_id2&parse_mode=HTML");
}
...
THIS BOT IS MADE WITH ♥️ BY  <code>@ecoxp</code> </b>",
 'parse_mode'=>'HTML',
 'reply_markup' => $free,
 ]);
        exit();
...
'inline_keyboard' => [
[['text' => "OWNER", 'url' => "https://t.me/ecoxp"],]
]]);
                $keyboard1 = json_encode([
'inline_keyboard' => [
[['text' => "CHANNEL", 'url' => "https://t.me/ccxentool"],
['text' => "GROUP", 'url' => "https://t.me/ccxenchat"],]
]]);

// if(!in_array($chatId, $premiumgp)){
	// $tch = json_decode(file_get_contents("https://api.telegram.org/bot5519693729:AAHjxAQWv6hbfXqsjeTFc3CvpHA4LjmHsag/getChatMember?chat_id=@ccxenchat&user_id=".$gId))->result->status;
...
// exit();
// }
        	// $tch = json_decode(file_get_contents("https://api.telegram.org/5519693729:AAHjxAQWv6hbfXqsjeTFc3CvpHA4LjmHsag/getChatMember?chat_id=@ccxenchat&user_id=".$gId))->result->status;
// if($tch != 'member' && $tch != 'creator' && $tch != 'administrator'){
// bot('sendMessage',['chat_id'=>$chatId,'reply_to_message_id'=>$message_id,'text'=>"Sorry <a href='tg://user?id=$gId'>$firstname</a>
// 
// You Need To Join My Update Channel To Get Regular Updates
...
function bot($method,$datas=[]){
    $url = "https://api.telegram.org/bot5519693729:AAHjxAQWv6hbfXqsjeTFc3CvpHA4LjmHsag/".$method;
    $ch = curl_init();
